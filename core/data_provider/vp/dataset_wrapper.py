...
class VPDatasetWrapper:
    ...
    def __init__(self, dataset_class, split,data_root_path, **dataset_kwargs):
        r"""
        ...
        if split == "train":
            train_data, val_data = dataset_class.get_train_val(data_root_path,**dataset_kwargs)
            ...
            test_data = dataset_class.get_test(data_root_path,**dataset_kwargs)
            self.datasets = {
                "main": test_data,
                "test": test_data
            }
