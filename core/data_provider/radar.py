...
class RadarDataset(data.Dataset):
    ...
    def __init__(self, split, data_root_path,num_frames=20, num_channels=3, img_size=64, horiz_flip_aug=True, isShow=False):
    ...
    def __getitem__(self, index):
        if self.isShow:
            ...
            for i in range(0, 15):
                fname = os.path.join(self.data_path, f'{i + 1}.png')
