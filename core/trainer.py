...
def plot_generate(avg_lpips, avg_mae, avg_mse, avg_psnr, avg_ssim, configs, itr):
    ...
    try:
        os.remove(configs.gen_frm_dir + 'plot/psnr_result_plot_' + str(itr - int(configs.test_interval)) + '.png')
    except:
        print("file not found!")
    plt.close()
    plt.plot(itrList, ssimList, color='red')
    ...
    try:
        os.remove(configs.gen_frm_dir + 'plot/ssim_result_plot_' + str(itr - int(configs.test_interval)) + '.png')
    except:
        print("file not found!")
    plt.close()
    plt.plot(itrList, lpipsList, color='aquamarine')
    ...
    try:
        os.remove(configs.gen_frm_dir + 'plot/lpips_result_plot_' + str(itr - int(configs.test_interval)) + '.png')
    except:
        print("file not found!")
    plt.close()
