...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='/kaggle/input/synpickdataset/SYNPICK/')
    parser.add_argument('--data_val_path', type=str, default='/kaggle/input/synpickdataset/SYNPICK/')
    parser.add_argument('--data_test_path', type=str, default='/kaggle/input/synpickdataset/SYNPICK/')
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/synpickdataset/model.ckpt-26000')
    parser.add_argument('--perforamnce_dir', type=str, default='/kaggle/working/MAUSelf/results/synpick/')
    parser.add_argument('--save_dir', type=str, default='/kaggle/working/MAUSelf/checkpoints/synpick/')
    parser.add_argument('--gen_frm_dir', type=str, default='/kaggle/working/MAUSelf/results/synpick/')
