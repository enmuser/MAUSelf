...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='E:\\MAUVersion\\MAU\data\\taxibj_dataset\\')
    parser.add_argument('--data_val_path', type=str, default='E:\\MAUVersion\\MAU\data\\taxibj_dataset\\')
    parser.add_argument('--data_test_path', type=str, default='E:\\MAUVersion\\MAU\data\\taxibj_dataset\\')
    ...
    parser.add_argument('--max_iterations', type=int, default=400000)
    parser.add_argument('--max_epoches', type=int, default=400000)
    ...
    parser.add_argument('--perforamnce_dir', type=str, default='results/taxibj/')
    parser.add_argument('--save_dir', type=str, default='checkpoints/taxibj/')
    parser.add_argument('--gen_frm_dir', type=str, default='results/taxibj/')
