...
def configs():
    ...
    parser.add_argument('--train_level_base_line', type=int, default=200000)
    parser.add_argument('--max_iterations', type=int, default=280)
    parser.add_argument('--max_epoches', type=int, default=280)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/taxibjdataset/model.ckpt-180')
    ...
    parser.add_argument('--result_zip_dir', type=str, default='/kaggle/working/MAUSelf/results/taxibj/')
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/taxibj_result_zip')
