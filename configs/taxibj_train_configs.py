...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=420)
    parser.add_argument('--max_epoches', type=int, default=420)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/taxibjdataset/model.ckpt-340')
