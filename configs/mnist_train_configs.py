...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=3100)
    parser.add_argument('--train_level_base_line', type=int, default=216000)
    parser.add_argument('--max_epoches', type=int, default=3100)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-3000')
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/mau_result_3000')
