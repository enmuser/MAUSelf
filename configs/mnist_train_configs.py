...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=28100)
    parser.add_argument('--train_level_base_line', type=int, default=216000)
    parser.add_argument('--max_epoches', type=int, default=28100)
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/mau_result_28000')
