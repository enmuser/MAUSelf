...
def configs():
    ...
    parser.add_argument('--pretrained_model_f', type=str, default='checkpoints/mau/model.ckpt-140000')
    parser.add_argument('--pretrained_model_b', type=str, default='checkpoints/mau/model.ckpt-40000')
