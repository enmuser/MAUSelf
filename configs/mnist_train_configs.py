...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=1440)
    parser.add_argument('--train_level_base_line', type=int, default=220000)
    parser.add_argument('--max_epoches', type=int, default=1440)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-1280')
