...
def configs():
    ...
    parser.add_argument('--pretrained_model_f', type=str, default='/kaggle/input/movingmnist/model.ckpt-140000')
    parser.add_argument('--pretrained_model_b', type=str, default='/kaggle/input/movingmnist/model.ckpt-40000')
