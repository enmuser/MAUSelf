...
def configs():
    ...
    parser.add_argument('--train_level_base_line', type=int, default=100000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/movingmnist/model.ckpt-435000')
