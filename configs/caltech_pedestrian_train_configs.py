...
def configs():
    ...
    parser.add_argument('--test_iterations', type=int, default=69000)
    parser.add_argument('--max_epoches', type=int, default=300000)
    parser.add_argument('--display_interval', type=int, default=1)
    parser.add_argument('--test_interval', type=int, default=1000)
    parser.add_argument('--snapshot_interval', type=int, default=1000)
    parser.add_argument('--num_save_samples', type=int, default=300)
    parser.add_argument('--n_gpu', type=int, default=1)
    # /kaggle/input/peddataset/model.ckpt-15000
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/peddataset/model.ckpt-69000')
