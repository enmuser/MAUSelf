...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=6100)
    parser.add_argument('--test_iterations', type=int, default=6100)
    parser.add_argument('--max_epoches', type=int, default=6100)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/peddataset/model.ckpt-6000')
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/caltech_pedestrian_new2_6100')
