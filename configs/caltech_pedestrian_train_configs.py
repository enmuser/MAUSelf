...
def configs():
    ...
    parser.add_argument('--max_epoches', type=int, default=2000)
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/caltech_pedestrian_4000')
