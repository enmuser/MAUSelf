...
def configs():
    ...
    parser.add_argument('--test_iterations', type=int, default=350000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/peddataset/model.ckpt-115000')
