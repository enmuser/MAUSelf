...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=10100)
    parser.add_argument('--test_iterations', type=int, default=10100)
    parser.add_argument('--max_epoches', type=int, default=10100)
    parser.add_argument('--display_interval', type=int, default=1)
    parser.add_argument('--test_interval', type=int, default=100)
    parser.add_argument('--snapshot_interval', type=int, default=100)
    parser.add_argument('--num_save_samples', type=int, default=60)
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/caltech_pedestrian_new2_10100')
