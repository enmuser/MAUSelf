...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='data/caltech_pedestrian_dataset/')
    parser.add_argument('--data_val_path', type=str, default='data/caltech_pedestrian_dataset/')
    parser.add_argument('--data_test_path', type=str, default='data/caltech_pedestrian_dataset/')
    ...
    parser.add_argument('--perforamnce_dir', type=str, default='results/caltech_pedestrian/')
    parser.add_argument('--save_dir', type=str, default='checkpoints/caltech_pedestrian/')
    parser.add_argument('--gen_frm_dir', type=str, default='results/caltech_pedestrian/')
