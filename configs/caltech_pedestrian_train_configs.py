...
def configs():
    ...
    parser.add_argument('--test_iterations', type=int, default=8000)
    parser.add_argument('--max_epoches', type=int, default=8000)
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/caltech_pedestrian_8000')
