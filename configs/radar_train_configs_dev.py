...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='data/radar_dataset')
    parser.add_argument('--data_val_path', type=str, default='data/radar_dataset')
    parser.add_argument('--data_test_path', type=str, default='data/radar_dataset')
    ...
    parser.add_argument('--max_iterations', type=int, default=12000)
    parser.add_argument('--max_epoches', type=int, default=12000)
    parser.add_argument('--train_level_base_line', type=int, default=24000)
    ...
    parser.add_argument('--perforamnce_dir', type=str, default='results/radar/')
    parser.add_argument('--save_dir', type=str, default='checkpoints/radar/')
    parser.add_argument('--gen_frm_dir', type=str, default='results/radar/')
    parser.add_argument('--result_zip_dir', type=str, default='results/radar/')
    parser.add_argument('--result_zip_file_name', type=str, default='results/mau_radar_18000')
