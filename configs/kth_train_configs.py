...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='/kaggle/input/kthdataset128/')
    parser.add_argument('--data_val_path', type=str, default='/kaggle/input/kthdataset128/')
    parser.add_argument('--data_test_path', type=str, default='/kaggle/input/kthdataset128/')
    parser.add_argument('--input_length', type=int, default=10)
    parser.add_argument('--real_length', type=int, default=30)
    parser.add_argument('--total_length', type=int, default=30)
    parser.add_argument('--pred_length', type=int, default=20)
    ...
    parser.add_argument('--max_iterations', type=int, default=700000)
    parser.add_argument('--max_epoches', type=int, default=700000)
    parser.add_argument('--test_iterations', type=int, default=700000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/kthdataset128/model.ckpt-287000')
