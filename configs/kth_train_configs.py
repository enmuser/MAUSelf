...
def configs():
    ...
    parser.add_argument('--real_length', type=int, default=50)
    ...
    parser.add_argument('--test_iterations', type=int, default=559000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/kthdataset128/model.ckpt-559000')
