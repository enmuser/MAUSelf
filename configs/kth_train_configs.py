...
def configs():
    ...
    parser.add_argument('--test_iterations', type=int, default=184000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/kthdataset128/model.ckpt-184000')
