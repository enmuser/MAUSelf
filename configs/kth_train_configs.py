...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=50100)
    parser.add_argument('--max_epoches', type=int, default=50100)
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/kth_result_50000')
