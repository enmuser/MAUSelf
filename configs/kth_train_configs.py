...
def configs():
    ...
    parser.add_argument('--data_train_path', type=str, default='/kaggle/input/kthdataset/KTH_64/')
    parser.add_argument('--data_val_path', type=str, default='/kaggle/input/kthdataset/KTH_64/')
    parser.add_argument('--data_test_path', type=str, default='/kaggle/input/kthdataset/KTH_64/')
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/kthdataset/model.ckpt-36000')
