...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=315100)
    parser.add_argument('--max_epoches', type=int, default=315100)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/kthdataset128/model.ckpt-315000')
    ...
    parser.add_argument('--result_zip_dir', type=str, default='/kaggle/working/MAUSelf/results/kth/')
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/kth_result_315000')
