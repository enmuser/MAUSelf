...
def configs():
    ...
    parser.add_argument('--max_iterations', type=int, default=92000)
    parser.add_argument('--max_epoches', type=int, default=92000)
    parser.add_argument('--train_level_base_line', type=int, default=480000)
    parser.add_argument('--display_interval', type=int, default=1)
    parser.add_argument('--test_interval', type=int, default=500)
    parser.add_argument('--snapshot_interval', type=int, default=1000)
    parser.add_argument('--num_save_samples', type=int, default=5)
    parser.add_argument('--n_gpu', type=int, default=1)
    # /kaggle/input/radardataset/model.ckpt-12000
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/radardataset/model.ckpt-68000')
    parser.add_argument('--perforamnce_dir', type=str, default='/kaggle/working/MAUSelf/results/radar/')
    parser.add_argument('--save_dir', type=str, default='/kaggle/working/MAUSelf/checkpoints/radar/')
    parser.add_argument('--gen_frm_dir', type=str, default='/kaggle/working/MAUSelf/results/radar/')
    parser.add_argument('--result_zip_dir', type=str, default='/kaggle/working/MAUSelf/results/radar/')
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/mau_radar_base_92000')
