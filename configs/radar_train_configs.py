...
def configs():
    ...
    parser.add_argument('--max_epoches', type=int, default=38000)
    ...
    parser.add_argument('--pretrained_model', type=str, default='/kaggle/input/radardataset/model.ckpt-25000')
    ...
    parser.add_argument('--result_zip_file_name', type=str, default='/kaggle/working/MAUSelf/mau_radar_38000')
